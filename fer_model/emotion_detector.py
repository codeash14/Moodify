# model for detecting facial emotions
...
while True:
    ...
    if len(rects) > 0:
        ...
        for (i, (emotion, prob)) in enumerate(zip(EMOTIONS, preds)):
            ...
            cv2.putText(frameClone, label, (fX, fY - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (30, 215, 96), 2)
            cv2.rectangle(frameClone, (fX, fY), (fX + fW, fY + fH), (30, 215, 96), 2)

            # draw the label + probability bar on the canvas
            w = int(prob * 300)
            cv2.rectangle(canvas, (5, (i * 35) + 5), (w, (i * 35) + 35), (30, 215, 96), -1)
            cv2.putText(canvas, text, (15, (i * 35) + 23), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (255, 255, 255), 2)
